...
- Generated: `C:\Users\curtiskricke\Desktop\WIth GPT\Folder to GPT\OReillyGreensboroPLC2_NC_Autogen.L5X`
...
Fast_Conv coverage       18 / 57  (gen 40)
Slow_Flt coverage        18 / 57  (gen 40)
...
- `PE_MISMATCH`: 20
- `PROGRAM_STRUCTURE_DIFFERENCE`: 27
- `SAFETY_MISMATCH`: 18
- `TOPOLOGY_MISMATCH`: 14

## Conveyor inventory

- Generated Fast_Conv conveyors: **40**
...
- Extra (in generated only): P100, P101, P102, P106, P110, P126, P134, P136, P136A, P142, P148, P150, P150A, P215, P226, P229, P230, P232, P238, P316, P324, P408
...
### P102 — `EXTRA_GENERATED`

- area         EXTRA    gen=`Transport_1` ref=`None`
- safety_zone  EXTRA    gen=`Transport_1_ESZone1` ref=`None`
- downstream   EXTRA    gen=`P106` ref=`None`
- exit_pe      EXTRA    gen=`NO_PE` ref=`None`

### P106 — `EXTRA_GENERATED`

- area         EXTRA    gen=`Transport_1` ref=`None`
- safety_zone  EXTRA    gen=`Transport_1_ESZone1` ref=`None`
- downstream   EXTRA    gen=`P110` ref=`None`
- exit_pe      EXTRA    gen=`NO_PE` ref=`None`

### P110 — `EXTRA_GENERATED`
...
- Coverage: gen 40 / ref 57; jam config matches on overlap: 12
...
- Extra conveyors: P100, P101, P102, P106, P110, P126, P134, P136, P136A, P142, P148, P150, P150A, P215, P226, P229, P230, P232, P238, P316, P324, P408
...
| Transport_1_Area_Fast | EXTRA | area_fast | — |
| Transport_1_Area_L1 | EXTRA | area_l1 | — |
| Transport_1_Area_L2 | EXTRA | area_l2 | — |
| Transport_1_Area_Slow | EXTRA | area_slow | — |
