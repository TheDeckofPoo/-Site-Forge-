...
### CONFIGIO WORDS RESOLVED
**32** active RTA words (0 unresolved among active Interface=RTA rows)

### PHYSICAL WORD MAP
`exports/plc2-configio-compiler/physical_word_map.json` — adapters `CP2RIO0/1`, `CP3RIO0/1/2` derived from Configio panel prefixes + eipcfg module match (no hard-coded 201→CP2RIO0)
...
| Site Forge visual (Auto Build graph PNG) | **PASS** (controller-scoped; compact external) |

### STUDIO CANDIDATE
`exports/studio-validation/ORNCCP2_configio_candidate.L5X`  
SHA256: `5572b5f5b86f4d738b184cea6e89f02c815e54f7bb28a3fb4ccf707fd2e1e855`

### Material improvement gate
**MET** — Configio-based semantics moved strongly toward finished PLC (I +135, O +56, WRONG_ADAPTER −133, exact matches 173).

## Related

- `docs/PLC2_CONFIGIO_COMPILER.md`
