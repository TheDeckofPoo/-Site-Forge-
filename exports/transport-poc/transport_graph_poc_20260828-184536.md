# Transport Build POC report (2026-08-28T18:45:36.789171+00:00)
...
## Issues
- MERGE5: node Straight has no P### tag
- MERGE5: node Straight has no P### tag
- MERGE5: node Straight has no P### tag
- MERGE5: node Straight has no P### tag
- MERGE5: node Straight has no P### tag
...
- `P400` area=`MERGE5` lanes=2 Straight + Straight → P400 hold=`runhold`

Fragment file: `transport_autogen_merges_20260828-184536.json`
