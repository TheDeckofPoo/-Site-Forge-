...
**SORTER_TRACK PACK readiness: READY_TO_IMPLEMENT** for Phase 1 hot emit (`pack_definition_version: 1`); compiler **NOT_STARTED**; divert trigger values still NOT_SUPPORTED — no hollow-complete claim.
