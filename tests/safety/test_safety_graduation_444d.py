...
class TestOri048PreEmitWriterFilter(unittest.TestCase):
    def test_autogen_passes_written_tags(self) -> None:
        ...
        self.assertIn("ORI-048: collect proven Safety writers BEFORE emit", src)
...
class TestOri052HardwareBacked(unittest.TestCase):
    def test_missing_hardware_not_ready(self) -> None:
        devices = [
        ...
        r = apply_hardware_backed_readiness(
        ...
        self.assertTrue(by["ESLS870"].get("hardwareBacked"))
