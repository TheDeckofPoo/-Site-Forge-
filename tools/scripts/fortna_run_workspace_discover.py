        ...
        sorter_ed.update(
            {
                ...
                "induct": sorter_canonical.get("induct") or {},
                "scanners": sorter_canonical.get("scanners") or [],
                "scan_zones": sorter_canonical.get("scan_zones") or [],
                "application_structure": sorter_canonical.get("application_structure") or {},
                "coverage": sorter_canonical.get("coverage") or {},
                "gate_f_fields": sorter_canonical.get("gate_f_fields") or [],
